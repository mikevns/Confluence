...
"%EXECUTABLE%" //IS//%SERVICE_NAME% --ServiceUser "NT AUTHORITY\NetworkService" ^
    ...
    --StartParams start ^
    --StopParams stop ^
    --JvmOptions "-Dcatalina.home=%CATALINA_HOME%;-XX:+UseG1GC;-XX:G1ReservePercent=20;-XX:ReservedCodeCacheSize=256m;-XX:+IgnoreUnrecognizedVMOptions;-XX:+ExplicitGCInvokesConcurrent;-Xlog:gc*:file=\"%CATALINA_HOME%\logs\gc-%%t.log\":tags,time,uptime,level:filecount=5,filesize=2M;-Dorg.apache.tomcat.websocket.DEFAULT_BUFFER_SIZE=32768;-Dsynchrony.enable.xhr.fallback=true;-Djava.awt.headless=true;-Datlassian.plugins.enable.wait=300;-Dcatalina.base=%CATALINA_BASE%;-D%ENDORSED_PROP%=%CATALINA_HOME%\endorsed;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties;%JvmArgs%" ^
    --JvmOptions9 "--add-opens=java.base/java.lang=ALL-UNNAMED#--add-opens=java.base/java.lang.reflect=ALL-UNNAMED#--add-opens=java.base/java.net=ALL-UNNAMED#--add-opens=java.base/java.io=ALL-UNNAMED#--add-opens=java.base/java.util=ALL-UNNAMED#--add-opens=java.base/java.util.concurrent.atomic=ALL-UNNAMED#--add-opens=java.base/sun.net.www.protocol.jar=ALL-UNNAMED#--add-opens=java.base/sun.net.www.protocol.http=ALL-UNNAMED#--add-opens=java.base/sun.net.www.protocol.https=ALL-UNNAMED#--add-opens=java.base/sun.util.locale=ALL-UNNAMED#--add-opens=java.management/javax.management=ALL-UNNAMED#--add-exports=java.base/sun.security.action=ALL-UNNAMED#--add-exports=java.base/sun.util.calendar=ALL-UNNAMED#--add-exports=java.naming/com.sun.jndi.ldap=ALL-UNNAMED#--add-exports=java.xml/com.sun.org.apache.xml.internal.utils=ALL-UNNAMED#--add-exports=java.desktop/sun.font=ALL-UNNAMED#--add-exports=java.base/sun.security.util=ALL-UNNAMED" ^
...
exit /b 1
:installed
mkdir "%ABS_PATH%..\.install4j" 2> NUL
echo|set /P = "%SERVICE_NAME%" > "%ABS_PATH%..\.install4j\installation.id"
