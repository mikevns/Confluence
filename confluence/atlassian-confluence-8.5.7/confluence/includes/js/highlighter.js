/**
 * @module confluence/highlighter
 */
define('confluence/highlighter', [
    'ajs',
    'underscore'
], function(
    AJS,
     ...
     */
    return function(highlightTokens, highlightTemplate) {
        var regex;
        var replaceValue;
...
require('confluence/module-exporter').exportModuleAsGlobal('confluence/highlighter', 'Confluence.Highlighter');
