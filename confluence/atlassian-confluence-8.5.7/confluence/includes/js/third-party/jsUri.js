// TODO: This file may no longer be used. Should check for usages and then delete.
/*!
 * jsUri
...
(function(global) {
    ...
    function parseUri(str) {
        /* Atlassian modifications to support @ as a normal character in a url */
        var parser = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@\/]*)(?::([^:@\/]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,
    ...
    /**
     * Atlassian modifications applied to the original jsUri here.  Removed all export mechanisms except for AMD and
     * applied the confluence specific namespace to the AMD definition.
     */
    define('confluence/jsUri', function() {
        return Uri;
    });
}(this));