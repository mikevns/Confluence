/**
 * @module confluence/entity-picker
 */
define('confluence/entity-picker', [
    'window',
    'document',
    'jquery'
], function(
        ...
        if (table) {
            try {
                ...
                EP.button.onclick = function() {
                    ...
                    var callback = window.opener;

                    // support a data attribute for providing the callback path
                    var callbackPath = $(this).attr('data-callback');
                    if (typeof callbackPath === 'undefined') {
                        callbackPath = this.className;
                    }
                    callbackPath = callbackPath.split('.');
...
require('confluence/module-exporter').safeRequire('confluence/entity-picker', function(EntityPicker) {
    'use strict';

    window.addEventListener('load', EntityPicker, false);
});
